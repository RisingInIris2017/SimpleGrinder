...
public class TileEntityCoalGrinder extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.field_145958_o : "Coal Grinder";
	}
	...
	public int getCookProgressScaled(int p_145953_1_) {
		return this.grindCookTime * p_145953_1_ / 200;
	}
			...
			if (this.grindBurnTime != 0 || this.grindItemStacks[1] != null && this.grindItemStacks[0] != null) {
				...
				if (this.isBurning() && this.canGrind()) {
				 ...
				 if (flag != this.grindBurnTime > 0)
		            {
		                flag1 = true;
		                CoalGrinder.updateGrindBlockState(this.grindBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		            }
			}
