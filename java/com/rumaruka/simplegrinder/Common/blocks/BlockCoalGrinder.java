...
public class BlockCoalGrinder extends BlockContainer implements ITileEntityProvider{
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, BlocksCore.lit_grinder.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlocksCore.lit_grinder.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, BlocksCore.coal_grinder.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlocksCore.coal_grinder.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (stack.hasDisplayName())
        {
            ...
            {
                ((TileEntityCoalGrinder)tileentity).setCustomInventoryName(stack.getDisplayName());
            }
        }
    }
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TileEntityCoalGrinder)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityCoalGrinder)tileentity);
