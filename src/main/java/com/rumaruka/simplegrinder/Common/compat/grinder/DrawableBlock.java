...
import com.rumaruka.simplegrinder.Common.compat.SimpleGrinderPlugin;
...
public class DrawableBlock implements IDrawableStatic {
    ...
    public void draw(Minecraft minecraft, int xOffset, int yOffset, int maskTop, int maskBottom, int maskLeft, int maskRight) {
        ...
        IIngredientRegistry ingredientRegistry = (IIngredientRegistry) SimpleGrinderPlugin.jeiRun.getRecipeRegistry();
